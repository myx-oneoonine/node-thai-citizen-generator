...
const runTests = () => {
  ...
  const testGeneratedIdLength = () => {
    ...
    assert.strictEqual(citizenId.length, 13, 'Generated citizen ID should have 13 digits');
  ...
  const testCheckDigitCalculation = () => {
    const testCases = [
      { input: '123990012423', expected: '1', description: 'Check digit for 123990012423' },
      { input: '123456789012', expected: '1', description: 'Check digit for 123456789012' },
      { input: '155990005047', expected: '2', description: 'Check digit for 155990005047' },
      { input: '819929274783', expected: '0', description: 'Check digit for 819929274783' },
      { input: '319795541816', expected: '0', description: 'Check digit for 319795541816' }
    ];
  ...
  const testGeneratedIdValidity = () => {
    ...
    assert.strictEqual(actualCheckDigit, calculatedCheckDigit.toString(), 
